 ...
 * uses the @ref ui.hostApi.UIDelegateFactory "UIDelegateFactory".
 *
 ...
 * @fqref{pluginSystem.CppPluginSystemUIDelegatePlugin}
...
class OPENASSETIO_UI_EXPORT CppPluginSystemUIDelegateImplementationFactory
 ...
 public:
  ...
  using CppPluginSystemPtr = openassetio::pluginSystem::CppPluginSystemPtr;
  ...
  /**
   * Get a list of all UI delegate plugin identifiers known to the
   * factory.
   *
  ...
  /**
   * Create an instance of the @fqref{managerApi.UIDelegateInterface}
 ...
 private:
  ...
  /// Private constructor. See @ref make.
  CppPluginSystemUIDelegateImplementationFactory(Str paths, log::LoggerInterfacePtr logger);
