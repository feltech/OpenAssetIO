...
#
"""
@namespace openassetio.ui.pluginSystem.PythonPluginSystemUIDelegateImplementationFactory
...
class PythonPluginSystemUIDelegateImplementationFactory(UIDelegateImplementationFactoryInterface):
    ...
    **PYTHONPATH** and doesn't need to be a subset of those paths. This
    ...
    library initialization. **OPENASSETIO_UI_PLUGIN_PATH** plugins take
    ...
    kDisableEntryPointsEnvVar = "OPENASSETIO_UI_DISABLE_ENTRYPOINTS_PLUGINS"

    ## The name of the UIDelegatePlugin entry point for entry point
    ## discovered plugins.
    kPackageEntryPointGroup = "openassetio.ui_plugin"

    ## The name of the top-level variable that references the plugin
    ## class.
    kModuleHookName = "openassetioUIPlugin"
